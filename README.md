...
See `DEPLOYMENT.md` for step-by-step instructions — deploys automatically to GitHub Pages via
the included GitHub Actions workflow (`.github/workflows/deploy.yml`) on every push to `main`.
